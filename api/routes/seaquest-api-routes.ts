...
router.post('/player/register', (req: any, res: any) => {
...
// Start Game Session
router.post('/game/start', (req: any, res: any) => {
...
// Game Action (scoring)
router.post('/game/action', (req: any, res: any) => {
...
function checkAchievements(player) {
  ...
  if (player.stats.gamesPlayed >= 10) achievements.push('🎮 Veteran Player');
  if (player.stats.bestScore >= 5000) achievements.push('🏆 High Scorer');
  if (player.tentaclesUnlocked.length >= 5) achievements.push('🐙 Tentacle Master');
  if (player.tokens >= 10000) achievements.push('💰 Token Millionaire');
