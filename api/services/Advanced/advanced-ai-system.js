...
class AIMetrics {
    metrics = {};
    record(provider, latencyMs, success, error) {
...
class AdvancedAISystem {
    ...
    async processQuery(query, tentacleStrategy, userId) {
        const context = {
            query,
    ...
    selectModelForStrategy(tentacle) {
        const strategyMap = {
    ...
    async callAnthropic(query, strategy, context) {
    ...
    async callOpenAI(query, strategy, context) {
    ...
    async callLocalLlama(query, strategy, context) {
    ...
    async callFuzzyLogic(query, strategy, context) {
        const templates = {
    ...
    buildPrompt(query, strategy, model) {
